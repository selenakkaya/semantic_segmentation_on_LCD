...
BATCH_SIZE = 10
DIM = 512
MODEL_NAME = "dropout_standard_unet_aug_wire_64.h5"
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/wire/loss_std_unet_aug_wire.png')
...
"""
sample_dir = "/home/sakkaya/std_unet/wire/samples_std_unet_aug_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS for wire + AUGMENTATION")
