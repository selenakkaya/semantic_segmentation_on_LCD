...
BATCH_SIZE = 10
DIM = 512
MODEL_NAME = "dropout_standard_unet_wire_64.h5"
...
checkpoint_path = "/home/sakkaya/std_unet/wire/checkpoints_dropout_std_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/wire/loss_dropout_std_unet_wire.png')
...
"""
sample_dir = "/home/sakkaya/std_unet/wire/samples_std_unet_dropout_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS std unet with DROPOUT layers")
