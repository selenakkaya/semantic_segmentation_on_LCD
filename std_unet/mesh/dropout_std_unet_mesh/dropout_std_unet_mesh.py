...
BATCH_SIZE = 12
DIM = 512
MODEL_NAME = "dropout_standard_unet_mesh_64.h5"
...
checkpoint_path = "/home/sakkaya/std_unet/mesh/checkpoints_dropout_std_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/mesh/loss_dropout_std_unet_mesh.png')
...
"""
sample_dir = "/home/sakkaya/std_unet/mesh/samples_std_unet_dropout_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS for mesh std unet with DROPOUT layers")
