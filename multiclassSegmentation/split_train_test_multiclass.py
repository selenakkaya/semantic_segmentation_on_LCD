"""
Split the dataset in train, validation and test for multiclass model.
The splitting is equally distributed between sites.
Square images cropped from one image go to the same set.
Save numpy array for the three splits for images and masks.
Run for mesh or wire
"""
...
images = np.load(src_path + "/images.npy")
masks = np.load(src_path + "/one_hot_masks.npy")
filenames = np.load(src_path + "/filenames.npy")
...
np.save(src_path + "/train_images.npy", train_images)
np.save(src_path + "/val_images.npy", val_images)
np.save(src_path + "/test_images.npy", test_images)
np.save(src_path + "/train_masks.npy", train_masks)
np.save(src_path + "/val_masks.npy", val_masks)
np.save(src_path + "/test_masks.npy", test_masks)
