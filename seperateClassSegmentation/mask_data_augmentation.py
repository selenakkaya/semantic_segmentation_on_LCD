...
train_images = np.load("saved_arrays/" + CATEGORY + "_train_images.npy")
train_masks = np.load("saved_arrays/" + CATEGORY + "_train_masks.npy")
val_images = np.load("saved_arrays/" + CATEGORY + "_val_images.npy")
val_masks = np.load("saved_arrays/" + CATEGORY + "_val_masks.npy")
...
np.save("saved_arrays/" + CATEGORY + "_aug_train_images.npy", aug_train_images)
np.save("saved_arrays/" + CATEGORY + "_aug_train_masks.npy", aug_train_masks)
np.save("saved_arrays/" + CATEGORY + "_aug_val_images.npy", aug_val_images)
np.save("saved_arrays/" + CATEGORY + "_aug_val_masks.npy", aug_val_masks)
