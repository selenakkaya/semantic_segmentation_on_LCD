...
if __name__ == '__main__':
    ...
    val_masks = np.load(src_path + "/" + CATEGORY + "_val_masks.npy")
    ...
    np.save(src_path + "/" + CATEGORY + "_aug_train_images.npy", aug_train_images)
    np.save(src_path + "/" + CATEGORY + "_aug_train_masks.npy", aug_train_masks)
    np.save(src_path + "/" + CATEGORY + "_aug_val_images.npy", aug_val_images)
    np.save(src_path + "/" + CATEGORY + "_aug_val_masks.npy", aug_val_masks)
