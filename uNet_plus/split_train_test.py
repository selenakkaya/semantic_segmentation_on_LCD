...
np.save(src_path + "/" + CATEGORY + "_train_images.npy", train_images)
np.save(src_path + "/" + CATEGORY + "_val_images.npy", val_images)
np.save(src_path + "/" + CATEGORY + "_test_images.npy", test_images)
np.save(src_path + "/" + CATEGORY + "_train_masks.npy", train_masks)
np.save(src_path + "/" + CATEGORY + "_val_masks.npy", val_masks)
np.save(src_path + "/" + CATEGORY + "_test_masks.npy", test_masks)
