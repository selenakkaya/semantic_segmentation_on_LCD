...
BATCH_SIZE = 12
DIM = 512
MODEL_NAME = "gs_adam_bfl_wire.h5"
...
checkpoint_path = "/home/sakkaya/std_unet_gs/wire/checkpoints_gs_adam_bfl_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet_gs/wire/loss_gs_adam_bfl_wire.png')
...
"""
sample_dir = "/home/sakkaya/std_unet_gs/wire/samples_gs_adam_bfl_wire_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS : Grid Search --> Adam + Binary Focal Loss")
