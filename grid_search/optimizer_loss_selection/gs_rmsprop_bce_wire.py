...
BATCH_SIZE = 16
DIM = 512
MODEL_NAME = "standard_unet_wire_64.h5"
...
checkpoint_path = "/home/sakkaya/std_unet/wire/checkpoints_std_unet_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/wire/loss_std_unet_wire.png')
...
"""
sample_dir = "/home/sakkaya/std_unet/wire/samples_std_unet_" + CATEGORY #where to save the predictions
