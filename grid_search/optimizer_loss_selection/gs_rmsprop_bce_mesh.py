...
BATCH_SIZE = 12
DIM = 512
MODEL_NAME = "gs_rmsprop_bce_mesh.h5"
...
checkpoint_path = "/home/sakkaya/std_unet/mesh/checkpoints_rmsprop_bce_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/mesh/loss_rmsprop_bce_mesh.png')
...
"""
sample_dir = "/home/sakkaya/std_unet/mesh/samples_rmsprop_bce_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS for mesh rmsprop + binary cross entropy ")
