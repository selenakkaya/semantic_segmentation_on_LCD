...
BATCH_SIZE = 12
DIM = 512
MODEL_NAME = "gs_rmsprop_bfl_mesh.h5"
...
checkpoint_path = "/home/sakkaya/std_unet_gs/mesh/checkpoints_gs_rmsprop_bfl_"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet_gs/mesh/loss_gs_rmsprop_bfl_mesh.png')
...
"""
sample_dir = "/home/sakkaya/std_unet_gs/mesh/samples_gs_rmsprop_bfl_mesh_" + CATEGORY #where to save the predictions
...
print("TEST RESULTS : Grid Search on mesh --> rmsprop + Binary Focal Loss")
