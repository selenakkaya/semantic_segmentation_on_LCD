...
BATCH_SIZE = 10
DIM = 512
MODEL_NAME = "adam_lr_0001_bce_wire.h5"
...
checkpoint_path = "/home/sakkaya/std_unet/wire/adam_lr_0001_bce_wire"+CATEGORY #where to save the model checkpoints
...
def unet(sz = (DIM, DIM, 3)):
  ...
  plt.legend()
  plt.show()
  plt.savefig('/home/sakkaya/std_unet/wire/adam_lr_0001_bce_wire.png')
