...
src_arr = "../processing/saved_arrays/mesh"
...
train_images = np.load(src_arr + "/mesh_aug_train_images.npy")
...
train_masks = np.load(src_arr + "/mesh_aug_train_masks.npy")
cw_masks = np.load(src_arr + "/cw_masks.npy")
train_masks = np.concatenate((train_masks, cw_masks), axis=0)
train_masks = np.expand_dims(train_masks, axis=-1)

val_images = np.load(src_arr + "/mesh_aug_val_images.npy")
val_images = val_images/255.0
val_masks = np.load(src_arr + "/mesh_aug_val_masks.npy")
val_masks = np.expand_dims(val_masks, axis=-1)

test_images = np.load(src_arr + "/mesh_test_images.npy")
test_images = test_images/255.0
test_masks = np.load(src_arr + "/mesh_test_masks.npy")
...
"""
sample_dir = "samples_mesh_cw" #where to save the predictions
